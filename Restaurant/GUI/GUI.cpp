...
void GUI::PrintSMessage(string msg,char x) const	//Prints a message on status bar
{
//	ClearStatusBar();	//First clear the status bar
	...
	if(x=='B')																// to be able to write multi-line
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.5)+20, msg);
	if(x=='C')
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.5)+40, msg);
	if(x=='D')
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.5)+60, msg);
}
//////////////////////////////////////////////////////////////////////////////////////////
